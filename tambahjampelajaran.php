...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO jam_pelajaran (jam_mulai, jam_selesai, hari) 
              VALUES ('$jam_mulai', '$jam_selesai', '$hari')";
    ...
    if ($result) {
        ...
        echo "<script>alert('Gagal menambahkan jam pelajaran');</script>";
    }
}
?>
  ...
  <div class="page-inner">
    <div class="page-header">
      ...
      <ul class="breadcrumbs mb-3">
        ...
        <li class="nav-item">Tambah Jam Pelajaran</li>
      </ul>
    </div>
    ...
    <form method="POST" style="max-width: 600px; margin: 20px auto;">
        <table>
            <tr>
                <th colspan="2" style="text-align: left;">Tambah Jam Pelajaran</th>
            </tr>
            <tr>
                <td style="width: 30%;"><label for="jam_mulai">Jam Mulai</label></td>
                <td><input type="time" name="jam_mulai" id="jam_mulai" required style="width: 100%; padding: 8px; border-radius: 6px; border: 1px solid #ccc;"></td>
            </tr>
            <tr>
                <td><label for="jam_selesai">Jam Selesai</label></td>
                <td><input type="time" name="jam_selesai" id="jam_selesai" required style="width: 100%; padding: 8px; border-radius: 6px; border: 1px solid #ccc;"></td>
            </tr>
            <tr>
